...
describe("Rewire", (function () {
        ...
        Jest.testAsync(/* None */0, "rewire.withRewiring supports direct reference of a global variable", (function (finish) {
                var rewiredModule = Rewire.rewire(testAssetLocation);
        ...
        Jest.testAsync(/* None */0, "rewire.withAsyncRewiring take a promised callback which resolves with variables reset to their original value", (function (finish) {
                var rewiredModule = Rewire.rewire(testAssetLocation);
                var all = { };
                all["someModule"] = {
                  param: /* param */"someMockedValue"
        ...
        return Jest.testAsync(/* None */0, "rewire.withAsyncRewiring supports direct reference of a global variable", (function (finish) {
                      var rewiredModule = Rewire.rewire(testAssetLocation);
