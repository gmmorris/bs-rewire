...
Jest.describe("Rewire", (function () {
        ...
        Jest.testAsync("rewire.withRewiring takes a callback in which values are mocked", /* None */0, (function (finish) {
                var rewiredModule = Rewire.rewire(testAssetLocation);
                var all = { };
                all["someModule"] = {
                  param: /* param */"someMockedValue"
        ...
        Jest.testAsync("rewire.withRewiring supports direct reference of a global variable", /* None */0, (function (finish) {
                var rewiredModule = Rewire.rewire(testAssetLocation);
                var rewiringCallback = Rewire.Rewired[/* withRewiringOver */4](rewiredModule, "someModule", {
                      param: /* param */"someMockedValue"
                    });
                return Curry._1(rewiringCallback, (function () {
                              return Curry._1(finish, Jest.Expect[/* toEqual */12]("someMockedValue", Jest.Expect[/* expect */0](Curry._1(getParam, rewiredModule))));
        ...
        Jest.testAsync("rewire.withAsyncRewiring take a promised callback which resolves with variables reset to their original value", /* None */0, (function (finish) {
                var rewiredModule = Rewire.rewire(testAssetLocation);
                var all = { };
                all["someModule"] = {
                  param: /* param */"someMockedValue"
                };
                var rewiringCallback = Rewire.Rewired[/* withAsyncRewiring */5](rewiredModule, all);
        ...
        return Jest.testAsync("rewire.withAsyncRewiring supports direct reference of a global variable", /* None */0, (function (finish) {
                      var rewiredModule = Rewire.rewire(testAssetLocation);
                      var rewiringCallback = Rewire.Rewired[/* withAsyncRewiringOver */6](rewiredModule, "someModule", {
                            param: /* param */"someMockedValue"
                          });
                      Curry._1(rewiringCallback, (function () {
                                return Promise.resolve(/* () */0);
